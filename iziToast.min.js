! function(t, e) {
    ...
    return e.setSetting = function(t, o, n) {
        ...
        v.toast.setAttribute("data-iziToast-ref", s.ref), v.toast.appendChild(v.toastBody), v.toastCapsule.appendChild(v.toast),
            function() {
            ...
            }(), s.image && (v.cover.classList.add(o + "-cover"), v.cover.style.width = s.imageWidth + "px", function(t) {
                try {
                    return btoa(atob(t)) == t
                } catch (t) {
                    return !1
                }
            }(s.image.replace(/ /g, "")) ? v.cover.style.backgroundImage = "url(data:image/png;base64," + s.image.replace(/ /g, "") + ")" : v.cover.style.backgroundImage = "url(" + s.image + ")", s.rtl ? v.toastBody.style.marginRight = s.imageWidth + 10 + "px" : v.toastBody.style.marginLeft = s.imageWidth + 13 + "px", v.toast.appendChild(v.cover)), s.close ? (v.buttonClose = document.createElement("button"), v.buttonClose.type = "button", v.buttonClose.classList.add(o + "-close"), v.buttonClose.addEventListener("click", (function(t) {
            ...
            function() {
                var t = s.position;
                if (s.target) v.wrapper = document.querySelector(s.target), v.wrapper.classList.add(o + "-target"), s.targetFirst ? v.wrapper.insertBefore(v.toastCapsule, v.wrapper.firstChild) : v.wrapper.appendChild(v.toastCapsule);
                else {
